...
export const ALL_LUOT_NHAN: LuotNhan[] = [
  ...
  { id: "LN-16/2026-GOVEX_HC", ngayNhan: "12/09/2026", nguoiNop: "Lê Văn C", hinhThuc: "Trực tiếp", noiDung: "Khiếu nại quyết định xử phạt vi phạm hành chính", donVi: "Phòng Hành chính - Tổng hợp", aiJob: 0, status: 'cho_chuyen', hasFile: false, ghiChu: "Công dân đến phản ánh về việc nhận quyết định xử phạt chưa thỏa đáng", sourceType: 'ghi_chu' },
];
