...
export default function NguonTraCuuModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden select-none">
      ...
      {/* 2. Slide-over Drawer Container (Trượt từ cạnh phải) */}
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-6 sm:pl-10 pointer-events-none">
        <div className="w-screen max-w-4xl lg:max-w-5xl bg-white shadow-2xl border-l border-slate-200/90 flex flex-col overflow-hidden pointer-events-auto animate-drawer-slide-in h-full">
          {/* 1. ADMINISTRATIVE DRAWER HEADER */}
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="font-extrabold text-slate-900 text-base tracking-tight font-headline-md">
                    Hồ sơ nguồn gốc &amp; Dữ liệu đối soát
                  </h3>
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                    CSDL Tiếp dân &amp; QLHC
                  </span>
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-blue-50 text-[#004ac6] border border-blue-200">
                    Ngăn kéo chi tiết (Drawer)
                  </span>
                </div>
          ...
          <div className="px-6 pt-3 border-b border-slate-200 bg-white flex items-center gap-2 shrink-0 overflow-x-auto">
            ...
            <button
              ...
              className={`pb-3 px-3 text-xs font-bold transition-all border-b-2 flex items-center gap-2 cursor-pointer shrink-0 ${activeTab === 'nguoi-gui'
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.2 rounded-full text-[10px] font-bold ${activeTab === 'nguoi-gui' ? 'bg-blue-100 text-[#004ac6]' : 'bg-slate-100 text-slate-600'
                  }`}
              >
                03 đơn gốc
              </span>
            ...
            <button
              ...
              className={`pb-3 px-3 text-xs font-bold transition-all border-b-2 flex items-center gap-2 cursor-pointer shrink-0 ${activeTab === 'don-tuong-tu'
            ...
            <button
              ...
              className={`pb-3 px-3 text-xs font-bold transition-all border-b-2 flex items-center gap-2 cursor-pointer shrink-0 ${activeTab === 'vu-viec'
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.2 rounded-full text-[10px] font-bold ${activeTab === 'vu-viec' ? 'bg-purple-100 text-purple-800' : 'bg-slate-100 text-slate-600'
                  }`}
              >
                Đang thụ lý PC03
              </span>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-[11.5px] text-slate-500 flex items-center gap-2">
                          ...
                          <span>•</span>
                          <span>Hình thức nộp: <strong className="text-slate-700">Trực tiếp</strong></span>
                        </p>
                      </div>
