...
export default function NhanDonThem({ onNav, onSubmit }: NhanDonThemProps) {
  ...
  const [coNguoiUyQuyen, setCoNguoiUyQuyen] = useState(false);
        ...
        <section className="space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3 p-1.5 bg-slate-100/90 rounded-2xl border border-slate-200/80">
            <button
              ...
              className={`p-3 rounded-xl flex items-center justify-center gap-2 text-[13.5px] font-semibold transition-all cursor-pointer ${loaiNguoiNop === 'khong-ro'
            ...
            <button
              ...
              className={`p-3 rounded-xl flex items-center justify-center gap-2 text-[13.5px] font-semibold transition-all cursor-pointer ${loaiNguoiNop === 'ca-nhan'
            ...
            <button
              ...
              className={`p-3 rounded-xl flex items-center justify-center gap-2 text-[13.5px] font-semibold transition-all cursor-pointer ${loaiNguoiNop === 'to-chuc'
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-xl border text-[13px] font-semibold transition-all cursor-pointer ${cnTuCach === 'nguoi-dung-don'
                  ...
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-xl border text-[13px] font-semibold transition-all cursor-pointer ${cnTuCach === 'nguoi-dai-dien'
                        ? 'bg-[#004ac6] text-white border-[#004ac6] shadow-xs'
                        : 'bg-slate-50 hover:bg-slate-100 text-slate-700 border-slate-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-xl border text-[13px] font-semibold transition-all cursor-pointer ${cnTuCach === 'nguoi-duoc-uy-quyen'
                        ? 'bg-[#004ac6] text-white border-[#004ac6] shadow-xs'
                        : 'bg-slate-50 hover:bg-slate-100 text-slate-700 border-slate-200'
                      }`}
                  >
